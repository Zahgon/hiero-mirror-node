...
public class RecalculatePendingRewardMigration extends AbstractJavaMigration {
    ...
    static final Map<String, Long> FIRST_NONZERO_REWARD_RATE_TIMESTAMP = Map.of(HederaNetwork.MAINNET, 1666310400447390002L, HederaNetwork.TESTNET, 1659139200596847383L);
