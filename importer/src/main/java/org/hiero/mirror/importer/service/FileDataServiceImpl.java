...
final class FileDataServiceImpl implements EntityListener, FileDataService {
    ...
    private static boolean isNewContent(FileData fileData) {
        ...
        return transactionType != null && (transactionType == TransactionType.FILECREATE.getProtoId() || (transactionType == TransactionType.FILEUPDATE.getProtoId() && fileData.getDataSize() > 0));
    }
}
