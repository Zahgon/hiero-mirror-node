...
public class CompositeBatchPersister implements BatchPersister {
    ...
    public CompositeBatchPersister(DataSource dataSource, MeterRegistry meterRegistry, CommonParserProperties properties, UpsertQueryGeneratorFactory upsertQueryGeneratorFactory, Optional<TransactionHashBatchInserter> transactionHashV1BatchPersister) {
        this.dataSource = dataSource;
        this.meterRegistry = meterRegistry;
        this.properties = properties;
        this.upsertQueryGeneratorFactory = upsertQueryGeneratorFactory;
        transactionHashV1BatchPersister.ifPresent(batchPersister -> batchPersisters.put(TransactionHash.class, batchPersister));
    }
