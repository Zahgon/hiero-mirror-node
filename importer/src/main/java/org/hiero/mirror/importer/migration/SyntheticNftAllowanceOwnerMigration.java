...
public class SyntheticNftAllowanceOwnerMigration extends RepeatableMigration implements RecordStreamFileListener {
    ...
    public SyntheticNftAllowanceOwnerMigration(@Owner ObjectProvider<JdbcOperations> jdbcOperationsProvider, ImporterProperties importerProperties, ObjectProvider<RecordFileRepository> recordFileRepositoryProvider) {
